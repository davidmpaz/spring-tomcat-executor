 ...
 */
@Slf4j
public class CustomThreadExecutor extends LifecycleMBeanBase implements Executor, ResizableExecutor {

    protected static final StringManager sm = StringManager.getManager(org.apache.catalina.core.StandardThreadExecutor.class);
    ...
    public CustomThreadExecutor() {
        ...
        log.debug("CustomThreadExecutor created");
    }
    ...
    protected void startInternal() throws LifecycleException {
        log.debug("CustomThreadExecutor.startInternal called");
    ...
    protected void stopInternal() throws LifecycleException {
        ...
        log.debug("CustomThreadExecutor.stopInternal called");
    ...
    public void execute(Runnable command) {
        log.debug("CustomThreadExecutor.execute called");
        if (executor != null) {
