...
Spring with embedded tomcat executor customization playground.

`com.example.demo.tomcat.CustomThreadExecutor` is an exact copy of: 
`org.apache.catalina.core.StandardThreadExecutor` with the exception
of the logging sentences.
